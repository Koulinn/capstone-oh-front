...
const BGURL =
    "https://res.cloudinary.com/koulin/image/upload/v1635416824/OneHealth/profileBG_xavs0i.svg";
function Profile({
    ...
    return (
        <div className="profile-wrapper col-12 col-md-6 d-flex flex-column align-items-center">
            <div
                data-hj-suppress
                className="avatar-wrapper d-flex flex-center-center position-relative"
            ...
            <div className="profile-meta-wrapper w-100 d-flex justify-content-center overflow-hidden px-3">
                <ProfileMeta
                    name={name}
                    surname={surname}
                    email={email}
